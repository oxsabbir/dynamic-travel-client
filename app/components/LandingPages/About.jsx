            ...
            <div className=" flex justify-between flex-col lg:flex-row lg:gap-0 gap-10">
              ...
              <div className=" w-full text-center lg:w-[60%] flex flex-col gap-5 ">
                <p className=" text-lg font-bold tracking-wide">
                  Travelling Is Way To Explore New Places. Learn A Wonderfull
                  Way To Explore New Places. Learn About Different Culture And
                  Gain New Exeperience Travelling Is A Wonderfull About
                ...
                <div className=" flex text-sm gap-8 flex-col md:flex-row text-textBlack">
                  ...
                  <p className="  ">
                    ...
                    About Different Culture And Gain New Exeperience Travelling
                    Is A Wonderfull Way To Explore New Places. Learn About
                    Different Culture And Gain New Exeperience
                  </p>
                  <div className=" bg-actionBlue p-1 rounded-full"></div>
                  <p className=" ">
